...
class PathListAdapter internal constructor(
    ...
    inner class PathViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val pathCardView: CardView = itemView.findViewById(R.id.cardView)
    ...
    override fun onBindViewHolder(holder: PathViewHolder, position: Int) {
        ...
        holder.pathCardView.setOnClickListener {
            listener(current)
        }
    }
    ...
    private fun applyProfilePicture(holder: PathViewHolder, path: Path) {
        ...
        holder.imgProfile.setColorFilter(path.color)
        holder.iconText.visibility  = View.VISIBLE
        //}
    }

    private fun applyIconAnimation(holder: PathViewHolder, position: Int, key: String?) {
